...
const PageTwo = () => {
  return (
    <>
    <header>
    <Header image={HeroBg} title={`About Us`} font={`Yesteryear`} color={`#FFF`} fontSize={`120px`} logo={logoImg} pages={[{'title':'Home' , 'route':'/'},{'title':'About' , 'route':'/about'},{'title':'Packages' , 'route':'/packages'},{'title':'Services' , 'route':'/home/#Category'}]} button={'Get in touch'}>
